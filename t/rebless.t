...
#03
is ($Devel::LeakTrack::Object::OBJECT_COUNT{Foo::Bar},1,'One Foo::Bar object');

bless $foo, 'Foo::Baz';
Devel::LeakTrack::Object::track($foo);

#04
is ($Devel::LeakTrack::Object::OBJECT_COUNT{Foo::Bar},0,'No Foo::Bar objects');

#05
is ($Devel::LeakTrack::Object::OBJECT_COUNT{Foo::Baz},1,'One Foo::Baz object');
